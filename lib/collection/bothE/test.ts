...
test('Get all outgoing or incoming edges of a specific type', t => {
  const actualResult = g
    .V('4')
    .bothE('created')
    .next();
...
test('Get all outgoing or incoming edges of a nonexistent type', t => {
  const actualResult = g
    .V()
    .bothE('uses')
    .next();
...
test('Get all  outgoing or incoming edges of any of multiple specified edge types', t => {
  const actualResult = g
    .V('4')
    .bothE('knows', 'created')
    .next();
