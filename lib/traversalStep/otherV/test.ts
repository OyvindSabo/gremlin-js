...
test('Get the other vertices from outgoing edges', t => {
...
test('Get the other vertices from incoming edges', t => {
  const actualResult = g
    .V()
    .in()
    .next();
...
test('Get the other vertices from outgoing or incoming edges', t => {
  const actualResult = g
    .V('4')
    .bothE()
    .otherV()
